...
export default function AddStudentPayment() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded shadow">
      ...
      <h2 className="text-xl font-bold mb-6">Add Student Payment</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium">Paid By (optional)</label>
            <input name="paidBy" className="input" />
          </div>
          <div>
