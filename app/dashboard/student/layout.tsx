...
import { BellIcon, CreditCardIcon, CheckCircleIcon, ChatBubbleLeftRightIcon, HomeIcon, CurrencyRupeeIcon, ArrowRightOnRectangleIcon, UserIcon } from '@heroicons/react/24/outline';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="font-semibold text-lg text-white">{user?.name || 'Student'}</span>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white bg-opacity-10 backdrop-blur-xl border-t border-white border-opacity-20 shadow-2xl z-40">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-around items-center h-16">
            <a href="/dashboard/student" className="flex flex-col items-center focus:outline-none transition-colors duration-300 text-white hover:text-blue-300">
              <HomeIcon className="h-6 w-6" />
              <span className="text-xs mt-1">Home</span>
            </a>
            <a href="/dashboard/student/notifications" className="flex flex-col items-center focus:outline-none transition-colors duration-300 text-gray-400 hover:text-white">
              <BellIcon className="h-6 w-6" />
              <span className="text-xs mt-1">Notifications</span>
            </a>
            <a href="/dashboard/student/payments" className="flex flex-col items-center focus:outline-none transition-colors duration-300 text-gray-400 hover:text-emerald-300">
              <CurrencyRupeeIcon className="h-6 w-6" />
              <span className="text-xs mt-1">Payments</span>
            </a>
            <a href="/dashboard/student/make-payment" className="flex flex-col items-center focus:outline-none transition-colors duration-300 text-gray-400 hover:text-indigo-300">
              <CreditCardIcon className="h-6 w-6" />
              <span className="text-xs mt-1">Make Payment</span>
            </a>
          </div>
        </div>
      </nav>
