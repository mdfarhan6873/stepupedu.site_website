...
import { ClipboardDocumentCheckIcon, CalendarDaysIcon, DocumentTextIcon, BellIcon, CurrencyRupeeIcon, ChatBubbleLeftRightIcon, AcademicCapIcon } from '@heroicons/react/24/outline';

const whatsappGroupLink = "https://chat.whatsapp.com/HEITVMEtis83Uy8vpWPmly";
...
const TeacherDashboard = () => {
  ...
  const quickActions = [
    { href: '/dashboard/teacher/mark-attendance', icon: ClipboardDocumentCheckIcon, label: 'Mark Attendance', gradient: 'from-blue-500 to-indigo-600' },
    { href: '/dashboard/teacher/schedules', icon: CalendarDaysIcon, label: 'Schedules', gradient: 'from-purple-500 to-pink-600' },
    { href: '/dashboard/teacher/notes', icon: DocumentTextIcon, label: 'Notes', gradient: 'from-violet-500 to-purple-600' },
    { href: '/dashboard/teacher/notifications', icon: BellIcon, label: 'Notifications', gradient: 'from-yellow-500 to-orange-500' },
    { href: '/dashboard/teacher/payments', icon: CurrencyRupeeIcon, label: 'My Payments', gradient: 'from-pink-500 to-rose-600' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="relative z-10 pt-16 pb-8 px-6">
        <div className="text-center">
          ...
          <p className="text-gray-300 text-lg">Inspiring minds, shaping futures</p>
      ...
      <div className="relative z-10 px-6 pb-24">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-xl rounded-3xl p-6 mb-8 border border-white border-opacity-20">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-white mb-2">Welcome Back, Teacher!</h2>
            <p className="text-gray-300">Ready to make a difference today?</p>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-xl px-3 py-1">
              <span className="text-gray-300 text-sm">Teaching Tools</span>
            </div>
          </div>
        ...
        {/* WhatsApp Section */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-white mb-6">Connect with Colleagues</h2>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">Join the teacher community</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white bg-opacity-10 backdrop-blur-xl rounded-2xl p-4 border border-white border-opacity-20">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-xs">Classes Today</div>
            </div>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-xl rounded-2xl p-4 border border-white border-opacity-20">
            <div className="text-center">
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-xl rounded-2xl p-4 border border-white border-opacity-20">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-xs">Pending Assignments</div>
            </div>
          </div>
          <div className="bg-white bg-opacity-10 backdrop-blur-xl rounded-2xl p-4 border border-white border-opacity-20">
            <div className="text-center">
              <div className="text-2xl font-bold text-white">92%</div>
              <div className="text-gray-300 text-xs">Class Attendance</div>
            </div>
          </div>
        </div>

        {/* Inspirational Quote */}
        <div className="bg-gradient-to-r from-emerald-500 to-teal-600 bg-opacity-20 backdrop-blur-xl rounded-3xl p-6 border border-white border-opacity-20">
          <div className="text-center">
            <p className="text-white text-lg font-medium italic mb-2">
              "A teacher affects eternity; they can never tell where their influence stops."
            </p>
            <p className="text-gray-300 text-sm">- Henry Adams</p>
          </div>
        </div>

        {/* Today's Schedule Preview */}
        {/* <div className="mt-8 bg-white bg-opacity-10 backdrop-blur-xl rounded-3xl p-6 border border-white border-opacity-20">
          <h3 className="text-xl font-bold text-white mb-4">Today's Schedule</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-white bg-opacity-5 rounded-2xl">
              <div>
                <p className="text-white font-medium">Mathematics - Grade 10</p>
                <p className="text-gray-300 text-sm">9:00 AM - 10:00 AM</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white bg-opacity-5 rounded-2xl">
              <div>
                ...
                <p className="text-gray-300 text-sm">11:00 AM - 12:00 PM</p>
              </div>
              <div className="w-2 h-2 bg-green-400 rounded-full"></div>
            </div>
            <div className="flex items-center justify-between p-3 bg-white bg-opacity-5 rounded-2xl">
              <div>
                <p className="text-white font-medium">Chemistry Lab - Grade 11</p>
